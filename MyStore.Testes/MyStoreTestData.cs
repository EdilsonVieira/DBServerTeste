...
namespace MyStore.Testes
{
    public class MyStoreTestData : IEnumerable<object[]>
    {
        ...
        {
           new object[] {Browser.Firefox, new PersonalInfo(TitleEnum.Mr, "Edilson", "Vieira", "edilson.vieira.br@gmail.com"
           ...
           new object[] {Browser.Firefox, new PersonalInfo(TitleEnum.Mr, "Edilson", "Vieira", "vieira.edilson@gmail.com"
               , "canada", DateTime.ParseExact("10/07/1969", "dd/MM/yyyy", CultureInfo.InvariantCulture), false, false
               , "DBServer", new Address("Rua Bahia, 288", "Sobrado - Brasilândia", "São Gonçalo", "Rio de Janeiro"
               , "24465", "Brazil"), "MyAddress", "", "", "992454633"), MyStorePageMap.PaymentByCheck}
        };
